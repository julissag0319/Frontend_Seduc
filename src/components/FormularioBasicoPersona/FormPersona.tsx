...
////////////////////////////////////////////////////////////////
const [tipo_cargo,setTipo_Cargo] = useState([{id_Tipo_Cargo:1,descripcion_Tipo_Cargo:"Supervision"}])
useEffect(()=>{
    ...
    <>
      ...
      <div className={`${flexInputContainer}`}>
          <div className={`${flexLabelInputs}`}>
            ...
            {touched.inputFieldnombre_Persona && errors.inputFieldnombre_Persona && (
        ...
        <div className={`${flexInputContainer}`}>
          <div className={`${flexLabelInputs}`}>
            ...
            {touched.inputFieldapellido_Persona && errors.inputFieldapellido_Persona && (
      ...
      <div className={`${flexInputContainer}`}>
        <div className={`${flexLabelInputs}`}>
          ...
          {touched.inputFieldidentidad_Persona && errors.inputFieldidentidad_Persona && (
      ...
      <div className={`${flexInputContainer}`}>
        <div className={`${flexLabelInputs}`}>
          ...
          {touched.inputFieldtelefono_Persona && errors.inputFieldtelefono_Persona && (
      ...
      <div className={`${flexInputContainer}`}> 
        <div className={`${flexLabelInputs}`}>
          ...
          {touched.inputFieldcorreo_Persona && errors.inputFieldcorreo_Persona && (
          ...
          <div className={`${flexLabelInputs}`}>
            <label className={`${labelStyle}`}>Id Tipo Cargo</label>
              <select
                ...
                disabled={isRemove ? true : false}>
                  <option>Seleccione una Opcion</option>
                  {tipo_cargo.map(({descripcion_Tipo_Cargo,id_Tipo_Cargo})=>(<option value={id_Tipo_Cargo}>{descripcion_Tipo_Cargo}</option>))}
              </select>
          </div>
  ...
  <div className={`${flexInputContainer}`}>
        ...
        <div className="flex items-right py-7 border-color-fondo align-center gap-3 justify-center">
          <button 
            ...
            onClick={notamjs}
           disabled={((
              inputFieldnombre_Persona.length < 3|| inputFieldnombre_Persona.length > 50) 
               || (inputFieldapellido_Persona.length < 3 || inputFieldapellido_Persona.length > 50)
               || (inputFieldidentidad_Persona.length < 6 || inputFieldidentidad_Persona.length > 50)
               || (inputFieldtelefono_Persona.length < 8 || inputFieldtelefono_Persona.length > 50)
               || (inputFieldcorreo_Persona.length < 6 || inputFieldcorreo_Persona.length > 50) 
              )}
